# Check Specialist GP's count is correct
...
* get expected results "Select count(*) as COUNT from account where specialist='Y' and GP = 'Y'"
* get actual results "Select count(*) as COUNT from specialist_gp"

## Check Specialist table counts
